-- Legends GUI Rework: FIXED GUI + All Functions
...
local function createGui()
    pcall(function()
        if LocalPlayer:FindFirstChild("PlayerGui") and LocalPlayer.PlayerGui:FindFirstChild("LBG_GUI") then
            LocalPlayer.PlayerGui.LBG_GUI:Destroy()
        end
