-- Legends Rise Script (Stable Version)
-- Includes: GUI + Aimlock + Auto Fly + Auto Block + Invincibility Reset
...
local function createGui()
    if LocalPlayer.PlayerGui:FindFirstChild("LBG_GUI") then
...
RunService.RenderStepped:Connect(function()
    ...
    if toggles.autofly and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
        ...
        if flying and flyVelocity and rootPart then
            ...
            flyVelocity.Velocity = dir.Unit * 75
        end
    elseif flying then
        stopFlying()
    end
