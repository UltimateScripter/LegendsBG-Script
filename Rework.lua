-- Legends Rise Script (Final Rework v3) -- Includes: GUI + Aimlock + Auto Fly (button-style) + Auto Block + Invincibility Reset
...
if flying and flyVelocity and rootPart then
    ...
    flyVelocity.Velocity = dir.Magnitude > 0 and dir.Unit * 75 or Vector3.zero
end
...
createGui() LocalPlayer.CharacterAdded:Connect(createGui)
